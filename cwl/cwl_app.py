...
class InputArgument:
    ...
    def to_string(self, value=None) -> str:
    ...
    def __boolean_to_string(self, value) -> str:
        return str(self.prefix) if value else ""

    def __process_value(self, value, str_quote="") -> str:
        if self.array:
    ...
    def __process_array_value(self, value, str_quote="") -> str:
        itm_sep = self.item_separator or " "
        str_value_list = [
            (
...
class CWLApp:
    ...
    def __set_inputs(self, cwl_inputs: list[dict[str, any]] | dict[str, any]) -> None:
    ...
    def __set_outputs(self, cwl_outputs: list[dict[str, any]] | dict[str, any]) -> None:
